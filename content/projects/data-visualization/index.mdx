...
summary:
  ...
  field. If you have a cool side project idea let me know. Here's a collection
  of products and experiments I've worked on."
...
This project was started as part of a cooperation between the energy company
Fortum, and the KTH Stockholm. The goal was creating awareness of energy
consumption among the general population through an ambient display in the
living room. You can play with the
[prototype here](http://henrilouis.com/webprojects/kth/vis/energy/).
...
Created in collaboration with Wouter Jansen and Ivo van Bon.
