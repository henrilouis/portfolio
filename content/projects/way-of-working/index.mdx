...
To create harmonized experiences in a large organzation making hundreds of
products, we incitivize people to do the right thing by creating easy reusable
assets that will save time.
...
If the code base allows it we prototype there instead and the last phase will be
enabling the feature for customers, however often a rigorous pre-development is
still required for a new product.
