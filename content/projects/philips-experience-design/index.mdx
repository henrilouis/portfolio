...
summary:
  "As a design lead at Philips I've been working with amazing clinicians,
...
- Lead design teams for the cardiology informatics and enterprise diagnostic
  ...
  providers.
- Act as the UX advocate within the businesses.
- Define design principles and create product visions with users and
  stakeholders.
...
complex while serving smaller niches in healthcare, leading to competition on
features, trying to catch up to the competition, leaving little room to make the
experience better.
...
<img
  src='./cco.png'
  alt='Cardiovascular care orchestrator'
...
<img src='./modules.png' alt='Modules' style='max-width:60em' />

<img src='./dashboard.jpg' alt='Dashboard' style='max-width:60em' />

<img src='./viewing.jpg' alt='Viewing' style='max-width:60em' />
